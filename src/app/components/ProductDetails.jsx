    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-orange-50 to-amber-50">
        <div className="text-center p-8 bg-white rounded-2xl shadow-xl max-w-md border border-orange-100">
          ...
          <Link href="/products" className="inline-block bg-gradient-to-r from-orange-500 to-red-500 text-white px-6 py-3 rounded-xl font-medium hover:from-orange-600 hover:to-red-600 transition-all shadow-lg">
            Browse Products
          </Link>
        </div>
      </div>
    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-amber-50 py-8 px-4">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex items-center text-sm text-gray-600 mb-6">
          ...
          <span className="mx-2">/</span>
          <Link href={`/category/${product.category?.slug}`} className="hover:text-orange-600">{product.category?.name}</Link>
          <span className="mx-2">/</span>
    ...
    <div className="space-y-3">
      ...
      {product.allergenInfo && (
        ...
        <div className="mt-8 text-center">
          <Link href="/products" className="inline-flex items-center text-orange-600 hover:text-orange-800 font-medium">
