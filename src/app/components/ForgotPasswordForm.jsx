...
const ForgotPasswordForm = () => {
  ...
  const sendOtp = async () => {
    try {
      await axios.post("https://ecom-backend-4-ysxq.onrender.com/auth/forgot-password", { email });
  ...
  const resetPassword = async () => {
    try {
      await axios.post("https://ecom-backend-4-ysxq.onrender.com/auth/reset-password", { email, otp, newPassword });
